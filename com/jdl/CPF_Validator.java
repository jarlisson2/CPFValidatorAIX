...
public class CPF_Validator extends AndroidNonvisibleComponent {
  ...
  @SimpleFunction(description = "Checks whether the CNPJ is returning the result in the CNPJValidator event.")
  public void CheckCNPJ(final String cnpj) {
    CNPJValidator(isCNPJ(cnpj), formatCNPJ(cnpj));
  }

  @SimpleEvent(description = "CNPJ check event.")
  public void CNPJValidator(final boolean isValid, final String formatCNPJ) {
    EventDispatcher.dispatchEvent(this, "CNPJValidator", isValid, formatCNPJ);
  }
  ...
  public static String formatCNPJ(final String CNPJ) {
    ...
    return (CNPJ.length() == 14
        ? CNPJ.substring(0, 2) + "." + CNPJ.substring(2, 5) + "." + CNPJ.substring(5, 8) + "/" + CNPJ.substring(8, 12)
